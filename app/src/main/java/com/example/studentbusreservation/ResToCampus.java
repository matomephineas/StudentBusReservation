...
public class ResToCampus extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_res_to_campus);
        ...
        toolbar.setTitle("Res to Campus");
        ...
        Query reference = FirebaseDatabase.getInstance().getReference("Destination").orderByChild("type").equalTo("Res");
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot item: snapshot.getChildren())
                {
                    ...
                    Toast.makeText(getApplicationContext(), desCity2, Toast.LENGTH_SHORT).show();
                }
